...
class Args:
    def __init__(self, cfg_path, gpu_id=3, model_type='vicuna', options=[]):
...
prompt_fp = '/home/dycpu3_8tssd/tonytong/Video-LLaMA/multi_agent/gpt_multiagent-0_round2.json'
...
file_path = f"./results/prompt_multiagent_round2.json"
