...
def gpt_refine(result_path, original_prompt, prompt_fp='gpt_multiagent_round2.txt'):
...
refined_name = '/home/dycpu3_8tssd/tonytong/Video-LLaMA/multi_agent/gpt_multiagent-0_round2.json'
