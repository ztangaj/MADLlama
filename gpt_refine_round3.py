...
def gpt_refine(result_path, original_prompt, prompt_fp='gpt_refine_round3.txt'):
    ...
    for k,v in result_data.items():
        try:
            r3_prompt_list.append(v["round3_prompt"])
            r3_result_list.append(v["round3_prediction"])
            r3_id_list.append(k)
        except:
            continue
    ...
    cur_prompt = cur_prompt.replace('{{Id3}}', str(r3_id_list))
    cur_prompt = cur_prompt.replace('{{Prompt3}}', str(r3_prompt_list))
    cur_prompt = cur_prompt.replace('{{Result3}}', str(r3_result_list))
...
gpt_temp_json_path = '/home/dycpu3_8tssd/tonytong/Video-LLaMA/results/round3_integration.json'
...
refined_name = '/home/dycpu3_8tssd/tonytong/Video-LLaMA/results/round3_refine.json'
